...
router.post('/create-study-details', function (req, res) {
    ...
    if (studyName && studyID) {
        ...
        req.session.data['studyDetailsSTATUS'] = "Completed";
...
router.post('/create-inclusion-exclusion-criteria', function (req, res) {
    ...
    if (addhealthConditions || addMedications || addAdditionalQuestion) {

        req.session.data['inclusionExclusionCriteriaSTATUS'] = "Completed";
