...
router.use('/researcher', require('./views/researcher/_routes'));
router.use('/volunteer', require('./views/volunteer/_routes'));
router.use('/admin', require('./views/admin/_routes'));
